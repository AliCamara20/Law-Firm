                ...
                <div className="navbar row">
                    ...
                    <nav className={navClassName} >
                        <ul className="nav_list row">
                            <li className="nav_item"><a href="" className="nav_link" onClick={ () => swipeContext(0)}>Home</a></li>
                            <li className="nav_item"><a href="" className="nav_link" onClick={ () => swipeContext(1)}>About</a></li>
                            <li className="nav_item"><a href="" className="nav_link" onClick={ () => swipeContext(2)}>Practice Areas</a></li>
                            <li className="nav_item"><a href="" className="nav_link" onClick={ () => swipeContext(3)}>Testimonials</a></li>
                            <li className="nav_item"><a href="" className="nav_link" onClick={ () => swipeContext(4)}>Attorney</a></li>
                            <li className="nav_item"><a href="" className="nav_link" onClick={ () => SwipeContext(5)} >Blog</a></li>
